...
public class MementoTest {
    public class Main {
        public static void main(String[] args) {
            ...
            commentList.add("A");
            final Tweet firstTweet = new Tweet("My first tweet", currentTime - ONE_HOUR, commentList);
            careTaker.saveStateList.add(firstTweet.saveToMemento());
            commentList.add("B");
            final Tweet secondTweet = new Tweet("My second tweet", currentTime, commentList);
            careTaker.saveStateList.add(secondTweet.saveToMemento());
            System.out.println(firstTweet.getCommentList());
            System.out.println(secondTweet.getCommentList());
        }
    }
}
